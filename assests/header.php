...
<head>
  ...
  <link rel="shortcut icon" href="http://microbeansindia.com/PMS/assests/img/favicon.png">
  <title>CoreUI - Open Source Bootstrap Admin Template</title>

  <!-- Icons -->
  <link href="http://microbeansindia.com/PMS/assests/node_modules/flag-icon-css/css/flag-icon.min.css" rel="stylesheet">
      ...
      <nav class="sidebar-nav">
        <ul class="nav">
         ...
         <!-- <li class="nav-title">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link"><i class="icon-drop"></i> Projects</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item nav-dropdown">
            ...
            <ul class="nav-dropdown-items">
              <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url() ?>Welcome/test"><i class="icon-puzzle"></i> Add New Project</a>
              </li>
            <!--  <li class="nav-item">
          ...
          <li class="nav-item nav-dropdown">
            ...
            <ul class="nav-dropdown-items">
              <li class="nav-item">
                <a class="nav-link" href="buttons-buttons.html"><i class="icon-cursor"></i> Add New Assest</a>
              </li>
            <!--  <li class="nav-item">
		    ...
		    <li class="nav-item nav-dropdown">
            <a class="nav-link nav-dropdown-toggle" href="#"><i class="icon-star"></i> Members</a>
            <ul class="nav-dropdown-items">
              <li class="nav-item">
                <a class="nav-link" href="icons-flags.html"><i class="icon-star"></i> Add New Member  <span class="badge badge-success">NEW</span></a>
              </li>
             <!-- <li class="nav-item">
          ...
          <li class="nav-item nav-dropdown">
            ...
            <ul class="nav-dropdown-items">
              <li class="nav-item">
                <a class="nav-link" href="notifications-alerts.html"><i class="icon-bell"></i> New Request</a>
              </li>
             <!-- <li class="nav-item">
